...
$prev_post = apply_filters( 'aurum_woocommerce_single_product_previous', get_adjacent_post( true, '', false, 'product_cat' ) );
$next_post = apply_filters( 'aurum_woocommerce_single_product_next', get_adjacent_post( true, '', true, 'product_cat' ) );

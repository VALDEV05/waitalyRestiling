<?php
/**
 *    Products Carousel Shortcode for WPBakery Page Builder
 *
 *    Laborator.co
 *    www.laborator.co
 */
	...
	public function content( $atts, $content = null ) {
        ...
        <div class="<?php echo $css_class; ?>" id="<?php echo $rand_id; ?>">
            ...
            <div class="products-loading">
				<?php esc_html_e( 'Loading products...', 'aurum' ); ?>
            </div>
                ...
                $products.slick( {
                    ...
                    responsive: [
                        ...
                        },
                        {
                            breakpoint: 520,
                            settings: {
                                slidesToShow: <?php echo $mobile_columns == 2 ? 2 : 1; ?>,
                                slidesToScroll: <?php echo $mobile_columns == 2 ? 2 : 1; ?>
                            }
                        }
                    ]
                } );
...
$opts = array(
	...
	'params'      => array(
		...
		array(
			...
			"description" => 'Select number of columns to use in mobile screen width.'
		),

...
function optionsframework_admin_message() {
    ...
    <script type="text/javascript">
        jQuery( function () {
            var message = '<p>Thank you for installing <strong>Aurum</strong> theme. To get started <a href="<?php echo admin_url( 'admin.php?page=theme-options' ); ?>">configure theme options</a> or install any demo content pack via our <a href="<?php echo admin_url( 'admin.php?page=laborator_demo_content_installer' ); ?>">1-Click Demo Content Installer</a>. Lean more about the theme by checking <a href="<?php echo admin_url( 'admin.php?page=laborator_docs' ); ?>">Theme Help</a> page.</p>';

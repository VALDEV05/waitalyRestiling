...
class GalleryBox {
	...
	public function add_metabox() {
		...
		if ( $this->_add_gallery_box() ) {
			add_meta_box( $this->field_id, $title, array(
				$this,
				'metabox_content'
			), $this->post->post_type, 'advanced' );
		}
	}
	...
	public function metabox_content( $post ) {
		...
		if ( version_compare( $wp_version, '3.5.0', '>=' ) ) {
			...
			?>
            <div>Your WordPress version (<?php echo $wp_version; ?>) doesn't support Gallery Box! Please
                <a href="<?php echo admin_url( 'update-core.php' ); ?>">update</a> your WordPress to 3.5 or newer
                version.
            </div>
			<?php
		}
	...
	private function gallery_box_style() {
        ...
        <style type="text/css">
            ...
            #<?php echo $id; ?>
            .gb_image_entry .gb_thumbnail .actions {
                position: absolute;
                bottom: 5px;
                right: 12px;
                left: 0px;
            ...
            #<?php echo $id; ?>
            .gb_image_entry:hover .gb_thumbnail .actions {
                -webkit-transition: all .37s linear;
                opacity: 1;
            }

            #<?php echo $id; ?>
            .gb_image_entry .gb_thumbnail .actions a {
            ...
            #<?php echo $id; ?>
            .gb_image_entry .gb_thumbnail .actions a.edit {
                -moz-border-radius: 4px 0px 0px 4px;
                -webkit-border-radius: 4px 0px 0px 4px;
                border-radius: 4px 0px 0px 4px;
            ...
            #<?php echo $id; ?>
            .gb_image_entry .gb_thumbnail .actions a.delete {
            ...
            #<?php echo $id; ?>
            .gb_image_entry .gb_thumbnail .img {
            ...
            #<?php echo $id; ?>
            .gb_image_entry .gb_details {
                float: left;
                width: 84.5%;
            }

            #<?php echo $id; ?>
            .gb_image_entry .gb_details .detail span {
                display: block;
                font-size: 8px;
            ...
            #<?php echo $id; ?>
            .gb_image_entry .gb_details .detail p {
                display: block;
                margin: 0;
                font-size: 11px;
                padding: 0;
            ...
            #<?php echo $id; ?>
            .gb_image_entry .gb_details .detail p.bold {
                font-weight: bold;
            }
	...
	public function gallery_box_html() {
        ...
        <div class="gallery_box_images_env" id="<?php echo $id; ?>_wrapper">
			<?php if ( count( $attachments ) ): ?>
                <div class="loading_images">Currently loading and
                    processing <?php echo $att_count == 1 ? '<strong>1 image</strong>' : "<strong>{$att_count}</strong> images"; ?>
                    ...
                </div>
			<?php endif; ?>

            <div class="no_images" style="<?php echo $att_count ? 'display: none' : ''; ?>">There are currently no
                images. Click <strong>Add Image</strong> to add or upload images.
            </div>
...
function gb_field( $field_id, $js_format = false, $inherit_imm = true ) {
	...
	$inherit_imm    = apply_filters( 'aurum_gallery_box_inherit_imm', $inherit_imm, $field_id );

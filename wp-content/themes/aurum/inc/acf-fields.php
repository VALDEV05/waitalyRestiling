...
if ( function_exists( 'register_field_group' ) ) {
	register_field_group( array(
		...
		'fields'     => array(
			...
			array(
				'key'           => 'field_5346vido3dk3d',
				'label'         => 'Map Style',
				'name'          => 'map_style',
				'type'          => 'textarea',
				'instructions'  => 'Paste the style code for map. Browse map styles in <a href="https://snazzymaps.com/" target="_blank">SnazzyMaps</a>',
				'default_value' => '',
				'placeholder'   => '',
				'maxlength'     => '',
				'rows'          => '',
			...
			array(
				...
				'default_value' => '',
				'placeholder'   => 'Example: This form collects your name and email so that we can subscribe you to our newsletter. Check our [aurum_privacy_policy title="privacy policy"] to learn how we protect and manage your submitted data.',
				'maxlength'     => '',
				'rows'          => '',
				'formatting'    => 'html',
			),

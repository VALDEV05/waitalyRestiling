...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<?php /* Modified by Arlind Nushi */ ?>
	<?php printf( '<a href="#" class="shipping-calculator-button button button-block button-large button-gray">%s</a>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'woocommerce' ) ) ); ?>

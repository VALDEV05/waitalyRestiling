...
<?php else : ?>
    ...
    <form method="post">
		...
		<?php aurum_woocommerce_section_title( apply_filters( 'woocommerce_my_account_edit_address_title', $page_title, $load_address ), aurum_woocmmerce_get_translated_string( 'Edit address information' ) ); ?>

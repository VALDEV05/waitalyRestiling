...
aurum_woocommerce_section_title( aurum_woocmmerce_get_translated_string( 'Pay Order' ), sprintf( '%s <a href="%s"><strong>#%d</strong></a>', aurum_woocmmerce_get_translated_string( 'You are making payment for order:' ), $order->get_view_order_url(), $order->get_id() ) );
...
<a href="<?php echo esc_url( wc_get_account_endpoint_url( 'orders' ) ); ?>" class="button button-small go-back"><?php aurum_woocmmerce_get_translated_string( '&laquo; Go back', true ); ?></a>

...
// Coupon wrapper start
echo is_cart() ? '<div class="checkout_coupon">' : '<form class="checkout_coupon woocommerce-form-coupon" method="post" style="display:none">';
